...
def summery_report(docs:str, reports:str) -> str:
    ...
    prompt = f"""
    Please integrate the following privacy policies, summarize the parts that are compliant with GDPR and the parts that are not compliant with GDPR, and provide suggestions for amendments:
...
if __name__ == '__main__':
    ...
    """    
    response = generate_compliant_report(doc)
    # report = """
    # {
    #     "compliant": [
    #         {
